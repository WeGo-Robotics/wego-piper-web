...
| 4 | **shm 전송 계층** — 카메라 **1~4 ☑**(추론·녹화 실기 확인) / 5(컨테이너) 대기 · [로봇](refactor/robot-transport.md) **2~3 ☑**(실기 확인) / 4~6 은 robotd | 데몬 분리의 전제조건. 깊이맵은 전송 검증 후로 미룸 |
| 5 | **rsd ☑ · camerad ☑** (버스 RPC · shm 발행) / **robotd = 다음** | **합치지 않았다** — D405 hang 이력. 게이트웨이는 이제 카메라 장치를 전혀 안 연다 |
