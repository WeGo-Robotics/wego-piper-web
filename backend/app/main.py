...
from app.routers import (
    ...
    health, hub, inference, logs, models, orchestrator, params, phase, policies,
    policy_server, presets, recording, robots, training, vision, ws,
)
...
ROUTERS = [
    ...
    encoder, activity, policies, presets, phase, devices, vision, orchestrator,
]
